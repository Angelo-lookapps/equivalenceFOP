...
@Entity
public class ChampArreteEqToChampArreteEqForm {

	public ChampArreteEqToChampArreteEqForm() {
		
	}
	public ChampArreteEqToChampArreteEqForm(Long id, Long idArreteEqRef, int numero, String delivreeA, String titulaireDe,
			String specialite) {
		super();
		this.id = id;
